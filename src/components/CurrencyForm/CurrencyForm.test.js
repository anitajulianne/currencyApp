...
describe('Component CurrencyForm', () => {
  ...
  it('should run action callback with proper data on form submit', () => {
    ...
    const fromSelectField = screen.getByTestId('from-select');
    const toSelectField = screen.getByTestId('to-select');

    // set test values to fields
    userEvent.type(amountField, testObj.amount );
    userEvent.selectOptions(fromSelectField, testObj.from );
    userEvent.selectOptions(toSelectField, testObj.to );
